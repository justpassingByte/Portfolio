  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-emerald-500/[0.02] blur-[160px] rounded-full" />
      </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="space-y-6 text-left">
              ...
              <p className="text-base sm:text-lg text-slate-300 font-light leading-relaxed max-w-xl">
                ...
                <span className="text-white font-normal">autonomous engineering systems</span>.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                ...
                >
                  <span>Explore Core Projects</span>
                ...
                >
                  ...
                  <span>Platform Ecosystems & Mindset</span>
                </Link>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative mx-auto max-w-sm rounded-3xl bg-[#090C15] border border-white/[0.08] p-6 shadow-2xl shadow-black/80 space-y-5">
                {/* Photo & Status */}
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/[0.1] shadow-inner group">
                  <Image
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-[11px] font-mono bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10 text-slate-300">
                ...
                <div className="space-y-2.5 font-mono text-xs">
                  ...
                  <div className="flex justify-between items-center py-1.5 border-b border-white/[0.06]">
                    ...
                    <span className="text-white font-medium">Autonomous Systems & Distributed Arch</span>
                  </div>
                  <div className="flex justify-between items-center py-1.5 border-b border-white/[0.06]">
                    <span className="text-slate-400">Distributed Core:</span>
                    <span className="text-slate-300">FSM • DB Locks • BullMQ</span>
                  </div>
                  <div className="flex justify-between items-center py-1.5">
                    <span className="text-slate-400">Autonomous Core:</span>
                    <span className="text-slate-300">CDP V8 • Playwright • MCP</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="about" className="relative z-10 scroll-mt-24">
        <div className="container mx-auto max-w-6xl space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#090C15] border border-white/[0.07] hover:border-white/[0.16] rounded-2xl p-6 space-y-3 transition-all">
              ...
              <h3 className="text-base font-semibold text-white">Distributed Platforms & Escrow</h3>
              <p className="text-sm text-slate-300 font-light leading-relaxed">
                Deterministic FSM transaction lifecycles, PostgreSQL row-level pessimistic locks, Redis distributed locks, and BullMQ background task processing.
              </p>
            </div>
            ...
            <div className="bg-[#090C15] border border-white/[0.07] hover:border-white/[0.16] rounded-2xl p-6 space-y-3 transition-all">
              ...
              <h3 className="text-base font-semibold text-white">Autonomous AI Systems</h3>
              <p className="text-sm text-slate-300 font-light leading-relaxed">
                Engineering multi-agent swarms: delegating scoped tasks to hierarchical subagents, invariant-bound CDP V8 heap inspection, MCP tool protocols, and automated verification loops.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl space-y-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {profileData.mindsets.map((item, index) => (
              <div
                key={item.title}
                className="bg-[#090C15] border border-white/[0.07] hover:border-white/[0.16] rounded-2xl p-6 space-y-3 transition-all"
              >
      ...
      <section id="systems" className="relative z-10 scroll-mt-24">
        <div className="container mx-auto max-w-6xl space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            >
              <span>Explore Project Architectures</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {profileData.systemHighlights.map((highlight) => (
              <div
                key={highlight.id}
                className="bg-[#090C15] border border-white/[0.07] hover:border-white/[0.16] rounded-2xl p-6 flex flex-col justify-between space-y-4 transition-all"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {profileData.techStackCategories.map((category) => (
              <div
                ...
                className="bg-[#090C15] border border-white/[0.07] rounded-2xl p-6 space-y-4"
              >
      ...
      {/* 7. FEATURED WORK (EDITORIAL SHOWCASE) */}
      <section id="projects" className="relative z-10 scroll-mt-24">
        <div className="container mx-auto max-w-6xl space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-400 max-w-xl font-light">
              From autonomous test operations and V8 heap debugging to multi-vendor digital escrow engines:
            </p>
          </div>

          {/* Editorial 1-Column Showcase */}
